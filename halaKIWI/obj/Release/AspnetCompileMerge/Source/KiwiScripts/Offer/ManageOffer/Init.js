...
$(document).ready(function () {
    ...
    $("#ddlDelivery").rules("add", { required: true, messages: { required: "Please Select Delivery" } });
    ...
    $("#ddlVDelivery").rules("add", { required: true, messages: { required: "Please Select Delivery" } });
